...
# @Last Modified time: 2018-10-08 16:14:27
import sys
import time
import os
import appinfo
...
class mainWindow(QMainWindow, Ui_MainWindow) :
    def __init__(self) :
        ...
        # status bar
        self.statusBar().showMessage('v'+appinfo._version_nuansa_dewata_ii)
...
if __name__ == '__main__' :
    ...
    window = mainWindow()
    window.setWindowTitle(appinfo._appname_nuansa_dewata_ii)
