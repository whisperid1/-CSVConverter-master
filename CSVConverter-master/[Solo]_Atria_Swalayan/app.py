...
# @Last Modified time: 2018-12-10 11:43:47
import sys
import time
import os
import appinfo
...
class mainWindow(QMainWindow, Ui_MainWindow) :
    ...
    def get_ponum(self) :
        ...
        result = sheet.cell_value(rowx=7, colx=3)
    ...
    def get_mdl(self) :
        ...
        result = self.get_cell_range(8, 12, 8, totalrow)
    ...
    def BtnCnv(self) :
        ...
        del brc[0] # delete first index from barcode
