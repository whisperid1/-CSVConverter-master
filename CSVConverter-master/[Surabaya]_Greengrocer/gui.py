...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btCnv.setGeometry(QtCore.QRect(90, 105, 151, 41))
        ...
        self.label.setGeometry(QtCore.QRect(130, 45, 71, 16))
        font = QtGui.QFont()
        ...
        self.edPonum = QtWidgets.QLineEdit(self.centralwidget)
        self.edPonum.setGeometry(QtCore.QRect(10, 65, 311, 22))
        self.edPonum.setObjectName("edPonum")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "PO Number"))
