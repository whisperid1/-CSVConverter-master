...
class mainWindow(QMainWindow, Ui_MainWindow) :
    def __init__(self) :
        ...
        self.cbOutlet.addItem('TJ.MORAWA [SUZUYA]', '571843')
        self.cbOutlet.addItem('MARELAN [SUZUYA]', '571846')
        self.cbOutlet.addItem('KP.BARU [SUZUYA]', '571845')
        self.cbOutlet.addItem('BINJAI [SUZUYA]', '571844')
