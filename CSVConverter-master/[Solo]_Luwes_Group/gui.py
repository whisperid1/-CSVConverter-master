...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btCnv.setGeometry(QtCore.QRect(90, 150, 151, 41))
        ...
        self.cbOutlet.setGeometry(QtCore.QRect(30, 102, 271, 22))
        self.cbOutlet.setObjectName("cbOutlet")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(130, 82, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Select store :"))
